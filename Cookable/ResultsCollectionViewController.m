...
- (void)viewDidLoad
{
    ...
    recipeImages = [NSArray arrayWithObjects:@"CookableResultTile.png", @"CookableResultTile.png", @"CookableResultTile.png",
                    @"CookableResultTile.png", @"CookableResultTile.png", @"CookableResultTile.png", @"CookableResultTile.png",
                    @"CookableResultTile.png", @"CookableResultTile.png", @"CookableResultTile.png", @"CookableResultTile.png", nil];
}
